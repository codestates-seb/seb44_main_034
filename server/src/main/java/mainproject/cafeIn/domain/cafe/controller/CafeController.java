...
public class CafeController {
    ...
    @GetMapping
    @ResponseStatus(OK)
    public ApplicationResponse<PageImpl<CafeResponse>> getCafes(SearchCafeFilterCondition searchCafeFilterCondition,
                                                            PageCafeRequest pageCafeRequest) {
        Long loginId = JwtParseInterceptor.getAuthenticatedUserId();
        PageImpl<CafeResponse> response = cafeService.searchCafesByFilterCondition(loginId, searchCafeFilterCondition, pageCafeRequest.of());
    ...
    @ResponseStatus(OK)
    public ApplicationResponse<PageImpl<CafeResponse>> findCafesByName(@PathVariable("cafe-name") String name,
                                                                  PageCafeRequest pageCafeRequest) {
        Long loginId = JwtParseInterceptor.getAuthenticatedUserId();
        PageImpl<CafeResponse> responses = cafeService.findCafesByName(loginId, name, pageCafeRequest.of());
    ...
    @ResponseStatus(OK)
    public ApplicationResponse<PageImpl<CafeResponse>> findCafesByMenu(@PathVariable("menu-name") String name,
                                                                   PageCafeRequest pageCafeRequest) {
        Long loginId = JwtParseInterceptor.getAuthenticatedUserId();
        PageImpl<CafeResponse> responses = cafeService.findCafesByMenu(loginId, name, pageCafeRequest.of());
